...
namespace OnlineSchoolAPI.Migrations
{
    ...
    [Migration("20260505180239_AddAdminDesktopDatabaseImprovements")]
    partial class AddAdminDesktopDatabaseImprovements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineSchoolAPI.Models.TrialApplicationComment", b =>
                {
                    ...
                    b.HasKey("CommentId")
                        .HasName("PK_trial_application_comment");

                    b.HasIndex("ApplicationId");

                    b.HasIndex("EmployeeId");

                    b.ToTable("trial_application_comment", (string)null);
                });

            modelBuilder.Entity("OnlineSchoolAPI.Models.TrialApplicationSubject", b =>
                {
                    b.Property<int>("ApplicationSubjectId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("application_subject_id");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ApplicationSubjectId"));
                    ...
                    b.HasKey("ApplicationSubjectId")
                        .HasName("PK_trial_application_subject");

                    b.HasIndex("SubjectId");

                    b.HasIndex(new[] { "ApplicationId", "SubjectId" }, "UQ_trial_application_subject_app_subject")
                        .IsUnique();

                    b.ToTable("trial_application_subject", (string)null);
                });
            ...
            modelBuilder.Entity("OnlineSchoolAPI.Models.TrialApplication", b =>
                {
                    ...
                    b.HasOne("OnlineSchoolAPI.Models.Course", "Course")
                        ...
                        .HasConstraintName("FK_trial_application_course_course_id");

                    b.HasOne("OnlineSchoolAPI.Models.Student", "Student")
                        .WithMany("TrialApplications")
                        .HasForeignKey("StudentId")
                        .HasConstraintName("FK_trial_application_student_student_id");
            ...
            modelBuilder.Entity("OnlineSchoolAPI.Models.TrialApplicationComment", b =>
                {
                    b.HasOne("OnlineSchoolAPI.Models.TrialApplication", "Application")
                        .WithMany("TrialApplicationComments")
                        .HasForeignKey("ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_trial_application_comment_trial_application");

                    b.HasOne("OnlineSchoolAPI.Models.Employee", "Employee")
                        .WithMany("TrialApplicationComments")
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("FK_trial_application_comment_employee");
            ...
            modelBuilder.Entity("OnlineSchoolAPI.Models.TrialApplicationSubject", b =>
                {
                    b.HasOne("OnlineSchoolAPI.Models.TrialApplication", "Application")
                        .WithMany("TrialApplicationSubjects")
                        .HasForeignKey("ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_trial_application_subject_trial_application");

                    b.HasOne("OnlineSchoolAPI.Models.Subject", "Subject")
                        .WithMany()
                        .HasForeignKey("SubjectId")
                        .IsRequired()
                        .HasConstraintName("FK_trial_application_subject_subject");
            ...
            modelBuilder.Entity("OnlineSchoolAPI.Models.Employee", b =>
                {
                    ...
                    b.Navigation("TrialApplicationComments");
            ...
            modelBuilder.Entity("OnlineSchoolAPI.Models.TrialApplication", b =>
                {
                    ...
                    b.Navigation("TrialApplicationSubjects");
                });
