...
public sealed class AdminProgressSubmissionDto
{
    ...
    [JsonIgnore]
    public IReadOnlyList<AdminProgressAnswerPreviewDto> AnswerTreeChildren => Answers;
}
...
public sealed class AdminProgressAssignmentDto
{
    ...
    /// <summary>Для TreeView: одна ветка «сдача» или пусто.</summary>
    [JsonIgnore]
    public IReadOnlyList<AdminProgressSubmissionDto> SubmissionTreeChildren =>
        Submission is null ? Array.Empty<AdminProgressSubmissionDto>() : new[] { Submission };
}
